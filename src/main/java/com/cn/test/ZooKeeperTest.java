...
public class ZooKeeperTest {
    ...
    public void connect() throws IOException {
        zooKeeper  = new ZooKeeper("10.10.1.163:2181", SESSION_TIMEOUT, watcher);
    }
    ...
    public void testGetChild() {
        try {
            zooKeeper.create("/zk/001", "001".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
            zooKeeper.create("/zk/002", "002".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
